...
class CommentConsumer(WebsocketConsumer):
    ...
    def new_message(self, data):
        ...
        def send_email():
            ...
            email_body = '<b>Comment:</b> '+new_comment.comment_text+' <b>Issue:</b> '+new_comment.comment_issue.issue_title+' <b>Project:</b> '+new_comment.comment_project.project_name
            email_sender = 'spuggy.sparsh@gmail.com'
            team_members_recipents = []
            team_members_recipents.append(new_comment.comment_issue.created_by.profile.email)
